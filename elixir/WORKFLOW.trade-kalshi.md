...
## Workflow
1. FIRST: use Symphony's built-in `linear_graphql` MCP tool to move the issue to `In Progress`.
...
7. Use the built-in `linear_graphql` MCP tool to attach the PR to the issue and move the issue to `In Review`.
